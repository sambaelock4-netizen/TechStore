<?php
/**
 * TECHSTORE - Admin Splash Screen Premium
 * Écran de démarrage admin avec animation premium
 */
...
$redirectDelay = 3;
$redirectUrl = '/TechStore/router.php?url=admin';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Admin TechStore - Chargement</title>
        ...
        * {
        ...
        .bg-animation::before {
            ...
            background: 
                ...
                radial-gradient(ellipse at 80% 20%, rgba(13, 110, 253, 0.1) 0%, transparent 50%),
                radial-gradient(ellipse at 40% 40%, rgba(25, 135, 84, 0.08) 0%, transparent 40%);
        ...
        .logo-container {
            width: 160px;
            height: 160px;
            background: linear-gradient(135deg, #2d1f1f 0%, #3d1a1a 50%, #4a1515 100%);
            border-radius: 40px;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .brand-text {
            ...
            letter-spacing: 6px;
            margin-bottom: 15px;
            background: linear-gradient(135deg, #ffffff 0%, #dc3545 50%, #0d6efd 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        ...
        .loading-bar {
            height: 100%;
            background: linear-gradient(90deg, #dc3545, #0d6efd, #dc3545);
...
<body>
    ...
    <div class="splash-container">
        ...
        <p class="tagline">Plateforme de Gestion Premium</p>
    ...
    <script>
        ...
        const countdownInterval = setInterval(function() {
            countdown--;
            if (countdown > 0) {
                document.querySelector('.countdown-text').textContent = 'REDIRECTION DANS ' + countdown + 'S';
            } else {
