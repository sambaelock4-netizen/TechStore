...
<head>
    ...
    <style>
        ...
        .ts-status-tab.all.active   { background:rgba(0,123,255,0.14); border-color:rgba(0,123,255,0.35); color:var(--blue-light); }
        ...
        .ts-status-tab.prep.active      { background:rgba(255,160,122,0.12); border-color:rgba(255,160,122,0.3); color:var(--red-light); }
        ...
        .ts-tl-dot.curr  { border-color:var(--red-light); background:var(--red-light); box-shadow:0 0 8px rgba(255,160,122,0.6); }
    ...
    <div class="ts-page-body">
        ...
        <div class="ts-stats-grid" style="margin-bottom:20px">
            <div class="ts-stat-card">
                <div class="ts-stat-icon" style="background:rgba(0,123,255,0.12);color:#3d9cff"><i class="fas fa-shopping-bag"></i></div>
