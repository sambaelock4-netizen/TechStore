...
body::before {
    ...
    inset: 0;
    background:
        radial-gradient(ellipse 70% 55% at 15% 15%, rgba(124,111,255,0.13) 0%, transparent 55%),
        radial-gradient(ellipse 55% 45% at 85% 85%, rgba(0,212,170,0.07) 0%, transparent 50%);
    pointer-events: none;
    z-index: 0;
}
</style>
...
<?php
/**
 * TECHSTORE - Admin Profile Premium
 */
?>
            ...
            <div class="col-lg-8">
                ...
                <div class="content-card">
                    <div class="card-header-custom">
                        <h3><i class="fas fa-user me-2"></i>Informations du profil</h3>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="content-card">
                    <div class="card-body-custom text-center">
                        ...
                        <h4 class="mt-3 mb-2"><?= htmlspecialchars(($user['firstname'] ?? '') . ' ' . ($user['lastname'] ?? '')) ?></h4>
...
document.addEventListener('click', function(e) {
    ...
    if (window.innerWidth <= 991 && s && t) {
        if (!s.contains(e.target) && !t.contains(e.target)) {
