...
<head>
    ...
    <style>
        ...
        .ts-stock-bar.rupture { background: linear-gradient(90deg,#f87171,#ffa07a); }
        ...
        .ts-mvt-exit    { background:rgba(255,160,122,0.10);color:#f87171;border-color:rgba(255,160,122,0.22); }
        .ts-mvt-adjust  { background:rgba(251,191,36,0.10);color:#fbbf24;border-color:rgba(251,191,36,0.22); }
        .ts-mvt-return  { background:rgba(0,123,255,0.10);color:#3d9cff;border-color:rgba(0,123,255,0.22); }
    ...
    <div class="ts-page-body">
        ...
        <div class="ts-stock-kpi-grid">
            <div class="ts-stat-card">
                <div class="ts-stat-icon" style="background:rgba(0,123,255,0.12);color:#3d9cff"><i class="fas fa-boxes"></i></div>
            ...
            <div class="ts-stat-card">
                <div class="ts-stat-icon" style="background:rgba(255,160,122,0.12);color:#f87171"><i class="fas fa-times-circle"></i></div>
